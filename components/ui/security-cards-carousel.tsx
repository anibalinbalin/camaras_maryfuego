...
import { IconArrowNarrowLeft, IconArrowNarrowRight, IconX } from "@/components/ui/tabler-icons-react"
...
export const SecurityCarousel = ({ items, initialScroll = 0 }: CarouselProps) => {
  ...
  return (
    <>
          ...
          <div className="fixed inset-0 z-50 h-screen overflow-auto">
            ...
            >
              ...
              <motion.p
                ...
                className="mt-4 text-2xl font-semibold text-foreground md:text-4xl"
              >
                {card.title}
              </motion.p>
      ...
      <motion.button
        layoutId={layout ? `card-${card.title}` : undefined}
        onClick={handleOpen}
        className="relative z-10 flex h-80 w-56 flex-col items-start justify-start overflow-hidden rounded-3xl bg-muted md:h-[30rem] md:w-80"
      >
        ...
        <Image
          ...
          alt={card.title}
          fill
          className="absolute inset-0 z-10 object-cover transition-transform duration-500"
        />
      </motion.button>
    </>
  )
