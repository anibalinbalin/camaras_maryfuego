...
import { GradientBentoGrid, GradientBentoGridItem } from "@/components/ui/gradient-bento-grid"

export default function SecurityBenefitsGradient() {
  const benefits = [
    {
  ...
  return (
    <div className="px-4 md:px-0">
      <GradientBentoGrid className="max-w-6xl mx-auto">
        {benefits.map((benefit, index) => (
          <GradientBentoGridItem
            key={index}
            area={benefit.area}
            icon={benefit.icon}
            title={benefit.title}
